      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col">
            <Link href="/" className="flex items-center gap-2 mb-6 group">
              ...
              <span className="font-heading font-bold text-xl uppercase tracking-wider">Usinagem</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/60 text-sm">Complexo Industrial WL<br />Polo Automotivo, São Paulo - SP</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/60 text-sm">vendas@wlprecision.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            &copy; 2026 WL Componentes de Precisão. Todos os direitos reservados.
          </p>
